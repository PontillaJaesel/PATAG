      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-6 px-6">
        ...
        <nav className="ml-auto flex items-center gap-1 text-sm">
          {items.map((it) => {
            ...
            const active = here === target || (target !== "/home" && here.startsWith(target + "/"));
            return (
              <Link
                key={it.to}
                to={it.to}
        ...
        <div className="flex items-center gap-3 pl-3 border-l border-white/15">
          ...
          <div className="grid h-8 w-8 place-items-center rounded-full bg-cream text-onyx text-xs font-semibold">
